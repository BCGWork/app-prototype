...
# profile_data[overall_rating=="", overall_rating:="N/A"]
# profile_data[idea_rating=="", idea_rating:="N/A"]
# profile_data[presentation_rating=="", presentation_rating:="N/A"]
# profile_data[video_quality=="", video_quality:="N/A"]
# profile_data[category=="", category:="N/A"]
# profile_data[style=="", style:="N/A"]
# profile_data[language=="", language:="N/A"]
